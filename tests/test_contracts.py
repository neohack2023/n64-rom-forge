...
class ContractTests(unittest.TestCase):
    ...
    def test_byte_order_magic(self) -> None:
        ...
        self.assertEqual(detect_byte_order(bytes.fromhex("37804012")), "v64")
        self.assertEqual(detect_byte_order(bytes.fromhex("40123780")), "n64")
        self.assertEqual(detect_byte_order(b"NOPE"), "unknown")

    def test_execution_receipt_defaults_to_not_run(self) -> None:
        receipt = ExecutionReceipt(
            schema="n64rf.execution-receipt.v1",
            plan_id="MASON-20260902-N64RF-PHASE0-SUBSTRATE-01",
            plan_digest="SHA256:bb66563dbf1871a433967807adf77d9f97780a8f755624c17e880a2916402fd8",
            repository="neohack2023/n64-rom-forge",
